...
const (
	AuthService_Login_FullMethodName           = "/mini_iam.auth.v1.AuthService/Login"
	AuthService_RefreshToken_FullMethodName    = "/mini_iam.auth.v1.AuthService/RefreshToken"
	AuthService_IntrospectToken_FullMethodName = "/mini_iam.auth.v1.AuthService/IntrospectToken"
	AuthService_Logout_FullMethodName          = "/mini_iam.auth.v1.AuthService/Logout"
)
...
//
// AuthService handles authentication: issuing, refreshing, introspecting,
// and revoking tokens. Internal, service-to-service contract.
//
// Note: the public JWKS endpoint (/.well-known/jwks.json) is intentionally
// NOT part of this gRPC contract — it is served as plain HTTP/JSON per
// RFC 7517 so that external JWT verifiers (which don't speak gRPC) can
// consume it directly.
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mini_iam.auth.v1.AuthService",
	...
	Metadata: "mini_iam/auth/v1/auth.proto",
}
